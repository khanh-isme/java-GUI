...
public class Editor {
    ...
    // Hàm để chỉnh sửa các thuộc tính của lớp project.Bank
    public void editBank(Bank bank) {
        while(true) {
            System.out.println("Select attribute to edit in project.Bank:");
    ...
    // Hàm để chỉnh sửa các thuộc tính của lớp project.Subject
    public void editSubject(Subject subject) {
        while(true) {
            System.out.println("Select attribute to edit in project.Subject (chose number):");
    ...
    // Hàm để chỉnh sửa các thuộc tính của lớp project.Quiz
    public void editQuiz(Quiz quiz) {
        while(true) {
            System.out.println("Select attribute to edit in project.Quiz (chose number):");
    ...
    // Hàm để chỉnh sửa các thuộc tính của lớp project.Question
    public void editQuestion(Question question) {
        while(true) {
            System.out.println("Select attribute to edit in project.Question (chose number) :");
            System.out.println("1. Content");
            System.out.println("2. Options");
            System.out.println("3. Correct project.Answer");
    ...
    public void deleteData(Bank bank) {
        while(true) {
            ...
            System.out.println("1. Delete project.Subject");
            System.out.println("2. Delete project.Quiz");
            System.out.println("3. Delete project.Question");
            System.out.println("4. exit");
            ...
            switch (choice) {
                case 1:
                    ...
                    if (subjectIndex >= 0 && subjectIndex < bank.getSubjects().size()) {
                        ...
                        System.out.println("project.Subject deleted.");
                    } else {
                ...
                case 2:
                    ...
                    if (subjIndex >= 0 && subjIndex < bank.getSubjects().size()) {
                        ...
                        if (quizIndex >= 0 && quizIndex < selectedSubject.getQuizzes().size()) {
                            ...
                            System.out.println("project.Quiz deleted.");
                        } else {
                            System.out.println("Invalid index.");
                        }
                    } else {
                    ...
                    if (subjectIdx >= 0 && subjectIdx < bank.getSubjects().size()) {
                        ...
                        if (quizIdx >= 0 && quizIdx < selectedSubj.getQuizzes().size()) {
                            ...
                            if (questionIdx >= 0 && questionIdx < selectedQuiz.getQuestions().size()) {
                                ...
                                System.out.println("project.Question deleted.");
                            } else {
                                System.out.println("Invalid index.");
                            }
                        } else {
    ...
    public void deleteQuiz(Student student) {
        ...
        if (choice >= 0 && choice < student.getQuizHistory().size()) {
            ...
            System.out.println("project.Quiz removed from student's quizzes taken.");
        } else {
            System.out.println("Invalid index.");
        }
    }
    ...
    public void deleteResult(Student student) {
        ...
        if (choice >= 0 && choice < student.getQuizHistory().size()) {
            student.getQuizHistory().remove(choice);
            System.out.println("project.Result removed from student's quiz history.");
        } else {
            System.out.println("Invalid index.");
        }
    }
    ...
    public void deleteQuiz(Teacher teacher) {
        ...
        if (choice >= 0 && choice < teacher.getQuizzesCreated().size()) {
            ...
            System.out.println("project.Quiz removed from teacher's quizzes created.");
        } else {
            System.out.println("Invalid index.");
        }
    }
