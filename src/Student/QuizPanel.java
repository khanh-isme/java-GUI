...
class QuizPanel extends JPanel {
    ...
    public QuizPanel(Quiz quiz, Student student , AtomicBoolean  flag) {
        ...
        this.flag = flag;
        this.elapsedTime=quiz.getTimeLimit();
        ...
        for (Question question : questions) {
            ...
            JLabel questionLabel = new JLabel((cnt + 1) + ". " + " "+ question.getContent());
